...
const nonDerivableFareRecord = new Record_1.default("non_derivable_fare_override", ["origin_code", "destination_code", "route_code", "railcard_code", "ticket_code", "nd_record_type", "end_date"], immutable_1.Map({
...
const NFO = new SingleRecordFile_1.default(nonDerivableFareRecord);
