...
const location = new Record_1.default("location", ["uic", "end_date"], immutable_1.Map({
...
const railcard = new Record_1.default("location_railcard", ["uic_code", "railcard_card", "end_date"], immutable_1.Map({
    "uic_code": new Text_1.default(2, 7),
