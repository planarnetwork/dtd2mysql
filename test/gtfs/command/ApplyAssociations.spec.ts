...
describe("ApplyAssociations", () => {
  ...
  it("matches the correct base schedule", () => {
    ...
    expect(result1.calendar.runsFrom.isSame("2017-07-10")).to.be.true;
    expect(result1.calendar.runsTo.isSame("2017-07-10")).to.be.true;
    ...
    expect(result2.calendar.runsFrom.isSame("2017-07-11")).to.be.true;
    expect(result2.calendar.runsTo.isSame("2017-07-11")).to.be.true;
