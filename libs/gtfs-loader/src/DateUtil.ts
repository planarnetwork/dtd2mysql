// GTFS.ts has no import of this file to match, but Service.ts does, so the module graph shows a
// cycle. It is a type-only edge and is erased on the way out, so neither output has one.
import type { DateNumber, DayOfWeek } from "./GTFS.js";
